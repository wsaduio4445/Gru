...
x_axis_background, y_axis_background = 0, 0
#Position of looping

background_game_over_image_filename = "Image/Menu/Game over/game_over.png"
background_game_over_image_loop = "Image/Menu/Game over/game_over.png"
background_game_over = pygame.image.load(background_game_over_image_filename).convert()
background_game_over_loop = pygame.image.load(background_game_over_image_loop).convert()
...
continue_button_disabled = pygame.image.load("Image/Menu/Main menu/continue_button_disabled.png")
    ...
    while menu:
        ...
        #Loop through the events
            ...
            #Check if user presses any key
                ...
                if game_continue == False:
                    ...
                    if new_game_selected == True and continue_selected == False and  option_selected == False and quit_selected == False:
                    #When start button is selected
                        if event.key == pygame.K_RETURN:
                            game = True
                            alive =True
                        ...
                        #If user presses down arrow key, the selection will move to option button
                            ...
                            option_selected = False
                            quit_selected = False
                    elif new_game_selected == False and continue_selected == True and option_selected == False and quit_selected == False:
                    #When option button is selected
                        if event.key == pygame.K_RETURN:
                        #If user presses enter key, move to option menu
                            game = True
                        ...
                        #If user presses down arrow key, the selection will move to quit button
                            ...
                            option_selected = True
                            quit_selected = False
                    elif new_game_selected == False and continue_selected == False and option_selected == True and quit_selected == False:
                    #When option button is selected
                        if event.key == pygame.K_RETURN:
                        #If user presses enter key, move to option menu
                            option = True
                        ...
                        #If user presses down arrow key, the selection will move to quit button
                            ...
                            option_selected = False
                            quit_selected = True
                    elif new_game_selected == False and continue_selected == False and option_selected == False and quit_selected == True:
                    #When quit button is selected
                        if event.key == pygame.K_RETURN:
                            menu = False
                            process = False
        ...
        if game_continue == False:
            ...
            #If start button is selected, highlight it, by drawing every button again
                screen.blit(new_game_button_selected, (592, 216))
                screen.blit(continue_button_disabled, (592, 272))
            ...
            #If option button is selected, highlight it, by drawing every button again
                screen.blit(new_game_button, (592, 216))
                screen.blit(continue_button_disabled, (592, 272))
            ...
            #If start button is selected, highlight it, by drawing every button again
                screen.blit(new_game_button_selected, (592, 216))
                screen.blit(continue_button, (592, 272))
                screen.blit(option_button, (592, 328))
                screen.blit(quit_button, (592, 384))
            elif new_game_selected == False and continue_selected == True and option_selected == False and quit_selected == False:
                screen.blit(new_game_button, (592, 216))
                screen.blit(continue_button_selected, (592, 272))
                screen.blit(option_button, (592, 328))
                screen.blit(quit_button, (592, 384))
            elif new_game_selected == False and continue_selected == False and option_selected == True and quit_selected == False:
            #If option button is selected, highlight it, by drawing every button again
