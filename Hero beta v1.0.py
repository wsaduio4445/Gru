...
#Keep looping through
    ...
    while game:
        ...
        if keys[0]: #and keys[1] == False and keys[2] == False and keys[3] == False:
            ...
            #player = player_up
        if keys[1]: #and keys[0] == False and keys[1] == False and keys[3] == False:
            player_position[1] += 0.1
            #player = player_down
        if keys[2]: #and keys[0] == False and keys[2] == False and keys[3] == False:
